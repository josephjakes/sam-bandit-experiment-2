...
jsPsych.plugins.instructions = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      var html = "<div class=jspsych-instructions>";
        
        html += "<div class=jspsych-instructions-text>";
          html += trial.pages[current_page];
        html += "</div>"; // jspsych-instructions-text

      if (trial.show_clickable_nav) {

        html += "<div class='jspsych-instructions-nav'>";
        if (current_page != 0 && trial.allow_backward) {
          html += "<button id='jspsych-instructions-back' class='jspsych-btn btn btn-outline-primary'>"+trial.button_label_previous+"</button>";
        }
        html += "<button id='jspsych-instructions-next' class='jspsych-btn btn btn-outline-primary'>"+trial.button_label_next+"</button></div>"

        html += "</div>"; // jspsych-instructions
        ...
        const next = display_element.querySelector('#jspsych-instructions-next');
